...
//   private final SimpleMotorFeedforward driveFeedforward;
  ...
  public SwerveModNeo(int moduleNumber, double offsets, int[] canIds) {
...
//   }
  ...
  private void configureDevices() {
    ...
    driveEncoder.setPositionConversionFactor(ModuleConstants.kDriveRatio);
    ...
    canCoder.configMagnetOffset(canCoderOffsetDegrees);
  }
}
